...
public class SynInCountTest {
    ...
    public void testProcessAllWindowFunction() throws Exception {
        ProcessAllWindowFunction<NMAJSONData, Long, TimeWindow> sumPackets = SynInCount.getProcessAllWindowFunction();
        ...
        Assert.assertEquals("5714", collector.toString());
    ...
    public void testProcessFunction() throws Exception {
        ProcessWindowFunction<NMAJSONData, Tuple2<Date, Long>, Date, TimeWindow> sumBytes = SynInCount.getProcessFunction();
        ...
        iterable = Arrays.asList(
                new NMAJSONData(example, "", "", "", "", 0l, 0l,1l,0l,0l,1l,0l,0l,0l,0l,0l),
                new NMAJSONData(example, "", "", "", "", 0l, 0l,2l,0l,0l,2l,0l,0l,0l,0l,0l),
                new NMAJSONData(example, "", "", "", "", 0l, 0l,3l,0l,0l,3l,0l,0l,0l,0l,0l),
                new NMAJSONData(example, "", "", "", "", 0l, 0l,4l,0l,0l,4l,0l,0l,0l,0l,0l)
        );
    ...
    public void testProcessSource() throws Exception {
        ...
        SynInCountTest.CollectSink.values.clear();
        ...
        SingleOutputStreamOperator<Tuple2<Date, Long>> datasource = SynInCount.processSource(senv, source);


//		datasource.printToErr();
        LOG.info("==============  ProcessSource Processed - PRINTED  ===============");
        datasource.addSink(new SynInCountTest.CollectSink());
//		datasource.printToErr();
        LOG.info("==============  ProcessSource Sink - PRINTED  ===============");
        senv.execute();

        for (Tuple2<Date, Long> l : SynInCountTest.CollectSink.values) {
            LOG.info(l.toString());
        }
